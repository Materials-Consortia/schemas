# list of fractional site positions (property)

This page documents an [OPTIMADE](https://www.optimade.org/) [Property Definition](https://schemas.optimade.org/#definitions). See [https://schemas.optimade.org/](https://schemas.optimade.org/) for more information.

**ID: [`https://schemas.optimade.org/defs/v1.3/properties/optimade/trajectories/fractional_site_positions`](https://schemas.optimade.org/defs/v1.3/properties/optimade/trajectories/fractional_site_positions.md)**  
**Definition name:** `fractional_site_positions`

**Property name:** list of fractional site positions  
