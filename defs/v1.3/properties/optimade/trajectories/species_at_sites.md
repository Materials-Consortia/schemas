# list of species at sites (property)

This page documents an [OPTIMADE](https://www.optimade.org/) [Property Definition](https://schemas.optimade.org/#definitions). See [https://schemas.optimade.org/](https://schemas.optimade.org/) for more information.

**ID: [`https://schemas.optimade.org/defs/v1.3/properties/optimade/trajectories/species_at_sites`](https://schemas.optimade.org/defs/v1.3/properties/optimade/trajectories/species_at_sites.md)**  
**Definition name:** `species_at_sites`

**Property name:** list of species at sites  
