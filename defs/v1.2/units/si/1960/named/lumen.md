...
**ID: [`https://schemas.optimade.org/defs/v1.2/units/si/1960/named/lumen`](https://schemas.optimade.org/defs/v1.2/units/si/1960/named/lumen)**  
...
``` json
{
    ...
    "defining-relation": {
        "base-units": [
            ...
            {
                "symbol": "sr",
                "id": "https://schemas.optimade.org/units/v1.2/si/1960/base/steradian"
            }
        ],
