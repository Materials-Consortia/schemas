...
**ID: [`https://schemas.optimade.org/defs/v1.2/units/si/prefixes/zebi`](https://schemas.optimade.org/defs/v1.2/units/si/prefixes/zebi)**  
...
``` json
{
    ...
    "$id": "https://schemas.optimade.org/defs/v1.2/units/si/prefixes/zebi",
    "title": "zebi",
    "symbol": "Zi",
    "display-symbol": "Zi",
    "description": "The zebi prefix as a dimensionless multiple of 2\u2077\u2070 is one of a set of recommended prefixes in the International System of Units (SI), 9th Edition for refering to powers of 2.",
