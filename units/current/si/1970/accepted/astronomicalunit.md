...
**ID: [`https://schemas.optimade.org/units/v1.2.0/si/1970/accepted/astronomicalunit`](https://schemas.optimade.org/units/v1.2.0/si/1970/accepted/astronomicalunit)**  
...
The redefined astronomical unit is regarded as a different unit and is thus not covered by this unit definition.
...
``` json
{
    "$id": "https://schemas.optimade.org/units/v1.2.0/si/1970/accepted/astronomicalunit",
