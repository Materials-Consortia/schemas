...
**ID: [`https://schemas.optimade.org/units/v1.2.0/si/prefixes/pebi`](https://schemas.optimade.org/units/v1.2.0/si/prefixes/pebi)**  
...
``` json
{
    "$id": "https://schemas.optimade.org/units/v1.2.0/si/prefixes/pebi",
    "title": "pebi",
    "symbol": "Ei",
    "display-symbol": "Ei",
    "description": "The pebi prefix as a dimensionless multiple of 2\u2075\u2070 is one of a set of recommended prefixes in the International System of Units (SI), 9th Edition for refering to powers of 2.",
