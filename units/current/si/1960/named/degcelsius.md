...
**ID: [`https://schemas.optimade.org/units/v1.2.0/si/1960/named/degcelsius`](https://schemas.optimade.org/units/v1.2.0/si/1960/named/degcelsius)**  
...
``` json
{
    "$id": "https://schemas.optimade.org/units/v1.2.0/si/1960/named/degcelsius",
    ...
    "defining-relation": {
        "base-units": [
            {
                "symbol": "degK",
                "id": "https://schemas.optimade.org/units/v1.2.0/si/1960/base/kelvin"
            }
        ],
