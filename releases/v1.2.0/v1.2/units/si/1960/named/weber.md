...
**ID: [`https://schemas.optimade.org/defs/v1.2/units/si/1960/named/weber`](https://schemas.optimade.org/defs/v1.2/units/si/1960/named/weber.md)**  
...
**Description:** A derived SI unit for magnetic flux equal to kg·m²·s⁻³·A⁻¹ in the 1960 SI base units.
...
``` json
{
    "$id": "https://schemas.optimade.org/defs/v1.2/units/si/1960/named/weber",
