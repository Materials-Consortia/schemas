...
**ID: [`https://schemas.optimade.org/defs/v1.2/units/si/prefixes/tebi`](https://schemas.optimade.org/defs/v1.2/units/si/prefixes/tebi)**  
...
``` json
{
    ...
    "$id": "https://schemas.optimade.org/defs/v1.2/units/si/prefixes/tebi",
    "title": "tebi",
    "symbol": "Ti",
    "display-symbol": "Ti",
    "description": "The tebi prefix as a dimensionless multiple of 2\u2074\u2070 is one of a set of recommended prefixes in the International System of Units (SI), 9th Edition for refering to powers of 2.",
