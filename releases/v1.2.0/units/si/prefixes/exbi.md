...
**ID: [`https://schemas.optimade.org/defs/v1.2/units/si/prefixes/exbi`](https://schemas.optimade.org/defs/v1.2/units/si/prefixes/exbi)**  
...
``` json
{
    ...
    "$id": "https://schemas.optimade.org/defs/v1.2/units/si/prefixes/exbi",
    "title": "exbi",
    "symbol": "Ei",
    "display-symbol": "Ei",
    "description": "The exbi prefix as a dimensionless multiple of 2\u2076\u2070 is one of a set of recommended prefixes in the International System of Units (SI), 9th Edition for refering to powers of 2.",
