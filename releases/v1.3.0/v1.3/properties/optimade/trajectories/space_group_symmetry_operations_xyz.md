# list of space group symmetry operations (property)

This page documents an [OPTIMADE](https://www.optimade.org/) [Property Definition](https://schemas.optimade.org/#definitions). See [https://schemas.optimade.org/](https://schemas.optimade.org/) for more information.

**ID: [`https://schemas.optimade.org/defs/v1.3/properties/optimade/trajectories/space_group_symmetry_operations_xyz`](https://schemas.optimade.org/defs/v1.3/properties/optimade/trajectories/space_group_symmetry_operations_xyz.md)**  
**Definition name:** `space_group_symmetry_operations_xyz`

**Property name:** list of space group symmetry operations  
...
- `[["x,y,z", "-x,y,-z", "x+1/2,y+1/2,z", "-x+1/2,y+1/2,-z"], ["x,y,z", "-x,y,-z"]]`
- `[["x,y,z", "-x,y,-z"]]`
