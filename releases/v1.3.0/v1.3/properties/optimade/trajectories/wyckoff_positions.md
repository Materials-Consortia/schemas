# list of Wyckoff positions (property)

This page documents an [OPTIMADE](https://www.optimade.org/) [Property Definition](https://schemas.optimade.org/#definitions). See [https://schemas.optimade.org/](https://schemas.optimade.org/) for more information.

**ID: [`https://schemas.optimade.org/defs/v1.3/properties/optimade/trajectories/wyckoff_positions`](https://schemas.optimade.org/defs/v1.3/properties/optimade/trajectories/wyckoff_positions.md)**  
**Definition name:** `wyckoff_positions`

**Property name:** list of Wyckoff positions  
